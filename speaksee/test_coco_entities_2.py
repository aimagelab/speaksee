from speaksee.data import ImageField, CocoMultipleAssociatedDetectionsField, TextField, RawField
...
saved_data = torch.load('saved_models/%s_best.pth' % opt_test.exp_name)
opt = saved_data['opt']
